...
public class LoadThucPhamIdAsyncTask extends AsyncTask<Void, Void, ArrayList<ThucMonModel>> {
    private OnGetAllMonAn onGetAllMonAn;
    private Context context;
    private String[] listId;

    public LoadThucPhamIdAsyncTask(OnGetAllMonAn onGetAllMonAn, String[] listId, Context context) {
    ...
    protected ArrayList<ThucMonModel> doInBackground(Void... voids) {
        ...
        arrayList.addAll(DatabaseManager.getInstance(context).getAllThucPhamWithId(listId));
        return arrayList;
    }
