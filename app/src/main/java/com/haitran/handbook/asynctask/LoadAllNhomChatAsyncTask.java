...
public class LoadAllNhomChatAsyncTask extends AsyncTask<Void, Void, ArrayList<ThucMonModel>> {
    private OnGetAllMonAn onGetAllMonAn;
    private Context context;

    public LoadAllNhomChatAsyncTask(OnGetAllMonAn onGetAllMonAn, Context context) {
    ...
    protected ArrayList<ThucMonModel> doInBackground(Void... voids) {
        ...
        arrayList.addAll(DatabaseManager.getInstance(context).getAllNhomChat());
        return arrayList;
    }
