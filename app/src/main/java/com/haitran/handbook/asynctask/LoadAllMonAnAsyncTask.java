...
public class LoadAllMonAnAsyncTask extends AsyncTask<Void, Void, ArrayList<ThucMonModel>> {
    private OnGetAllMonAn onGetAllMonAn;
    private Context context;

    public LoadAllMonAnAsyncTask(OnGetAllMonAn onGetAllMonAn, Context context) {
    ...
    protected ArrayList<ThucMonModel> doInBackground(Void... voids) {
        ...
        arrayList.addAll(DatabaseManager.getInstance(context).getAllMonAn());
        return arrayList;
    }
