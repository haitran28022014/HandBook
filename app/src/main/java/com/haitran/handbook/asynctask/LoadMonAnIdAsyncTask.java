...
public class LoadMonAnIdAsyncTask extends AsyncTask<Void, Void, ArrayList<ThucMonModel>> {
    private OnGetAllMonAn onGetAllMonAn;
    private Context context;
    private String[] listId;

    public LoadMonAnIdAsyncTask(OnGetAllMonAn onGetAllMonAn, String[] listId, Context context) {
    ...
    protected ArrayList<ThucMonModel> doInBackground(Void... voids) {
        ...
        arrayList.addAll(DatabaseManager.getInstance(context).getAllMonAnWithId(listId));
        return arrayList;
    }
